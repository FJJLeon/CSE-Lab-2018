...
#define BLOCK_SIZE (1024*16)     // 16384
#define BLOCK_NUM  (DISK_SIZE/BLOCK_SIZE) //2048
...
// nblocks/BPB means such blocks need to be used for bitmap

// Bitmap bits per block
#define BPB           (BLOCK_SIZE*8)  // 4096
